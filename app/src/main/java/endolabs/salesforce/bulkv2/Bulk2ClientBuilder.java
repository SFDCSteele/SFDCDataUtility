...
public class Bulk2ClientBuilder {
    ...
    private boolean usePassedURL;

    private String TOKEN_REQUEST_ENDPOINT_CUSTOM = "";
    ...
    public Bulk2ClientBuilder useCustomURL(String passedURL) {
        this.usePassedURL = true;
        this.TOKEN_REQUEST_ENDPOINT_CUSTOM = passedURL;
        return this;
    }
    ...
    private AccessToken getAccessTokenUsingPassword(String consumerKey, String consumerSecret, String username, String password) {
        ...
        if ( usePassedURL ) {
            endpoint = TOKEN_REQUEST_ENDPOINT_CUSTOM+"/services/oauth2/token";
        }
